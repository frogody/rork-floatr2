...
export const mockCrews: Crew[] = [
  {
    ...
    distance: 0.8,
    photoUrl: 'https://images.unsplash.com/photo-1543294001-f7cd5d7fb516?q=80&w=1000',
    photoUrls: [
  ...
  },
  {
    ...
    distance: 4.7,
    photoUrl: 'https://images.unsplash.com/photo-1566438480900-0609be27a4be?q=80&w=1000',
    photoUrls: [
